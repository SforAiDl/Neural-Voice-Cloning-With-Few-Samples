...
class MelSpecDataSource(_NPYDataSource):
    def __init__(self, data_root, speaker_id=None,train=0):
        super(MelSpecDataSource, self).__init__(data_root,'mel', 1, speaker_id,train)


class LinearSpecDataSource(_NPYDataSource):
    def __init__(self, data_root, speaker_id=None,train=0):
        super(LinearSpecDataSource, self).__init__(data_root,'spec', 0, speaker_id,train)
